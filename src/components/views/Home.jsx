                ...
                <div className='bg-newPink flex justify-center pb-14'>
                    <div className='flex flex-col lg:px-0 px-5  lg:w-[70%] space-y-14'>
                        ...
                        <div className='relative flex flex-col font-semibold w-fit'>
                            <p className='outline-text text-newPink text-6xl sm:text-8xl'>Open</p>
                            <img src={arrow} alt='arrow' className='sm:w-20 sm:h-20 w-14 h-14 absolute right-0 top-3 sm:top-10' />
                            <p className=' text-newSomon sm:text-8xl text-6xl text-nowrap'>School Days</p>
                        </div>
